...
const script_form = document.querySelector('.form.js--form');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(formBtn).on('click', function (event) {
    event.preventDefault();
    const formInput = jquery__WEBPACK_IMPORTED_MODULE_0___default()(script_form).find('input');
